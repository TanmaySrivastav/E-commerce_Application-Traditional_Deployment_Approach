...
//			user.getRoles().add(role);
			...
			if ("ADMIN".equalsIgnoreCase(userDTO.getRole())) {
				role = roleRepo.findById(AppConstants.ADMIN_ID).orElseThrow(() -> new ResourceNotFoundException("Role", "id", AppConstants.ADMIN_ID));
			} else {
				role = roleRepo.findById(AppConstants.USER_ID).orElseThrow(() -> new ResourceNotFoundException("Role", "id", AppConstants.USER_ID));
			}
			user.getRoles().add(role);
